...
export const SignupPage = () => {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    e.preventDefault();
    setError('Email signup coming soon. Please use Google for now.');
  };
    ...
    <div className="min-h-[80vh] flex items-center justify-center px-6">
      ...
      >
        <div className="text-center mb-10">
          <h1 className="text-3xl font-bold mb-2 tracking-tight font-serif text-brand-dark">Create Account</h1>
          <p className="text-gray-400 text-sm font-medium">Join the Shopix community</p>
        </div>
        ...
        <div className="mt-8 flex items-center gap-4">
          ...
          <span className="text-[10px] font-bold text-gray-300 uppercase tracking-widest">Or Signup With</span>
          <div className="h-px bg-gray-100 flex-1" />
        </div>
        ...
        <p className="mt-10 text-center text-sm text-gray-400 font-medium">
          Already have an account? <Link to="/login" className="text-brand-dark font-bold hover:underline">Login</Link>
        </p>
      </motion.div>
    </div>
  );
